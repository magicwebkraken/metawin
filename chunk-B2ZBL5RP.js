import { a as x } from "./chunk-PHY5CPHD.js";
import { a as f } from "./chunk-NZR2LZWU.js";
import { a as w, b as h } from "./chunk-ISXP6GOO.js";
import { c as d, g as b, h as P, k as v } from "./chunk-L4ZNINEC.js";
import { e, k as p } from "./chunk-ICDT4GZS.js";
import { q as C, s as u } from "./chunk-U7GUEFJZ.js";
var A = d`
  :host {
    display: block;
  }
...
var W = function (t, i, a, o) {
    ...
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
      r = Reflect.decorate(t, i, a, o);
    else
      for (var l = t.length - 1; l >= 0; l--)
        (s = t[l]) && (r = (n < 3 ? s(r) : n > 3 ? s(i, a, r) : s(i, a)) || r);
    return n > 3 && r && Object.defineProperty(i, a, r), r;
  },
  g = class extends p {
    constructor() {
      super(...arguments),
    ...
    firstUpdated() {
      (this.status = x.hasFooter() ? "show" : "hide"),
    ...
    onNetworkHelp() {
      C.sendEvent({ type: "track", event: "CLICK_NETWORK_HELP" }),
        u.push("WhatIsANetwork");
    }
    getWrapper() {
...
g.styles = [A];
W([h()], g.prototype, "status", void 0);
W([h()], g.prototype, "view", void 0);
g = W([v("w3m-footer")], g);
var E = d`
  :host {
    display: block;
...
y.styles = [E];
$([h()], y.prototype, "viewState", void 0);
$([h()], y.prototype, "history", void 0);
y = $([v("w3m-router")], y);
var R = d`
  :host {
    position: relative;
...
var O = function (t, i, a, o) {
  ...
  S = class extends p {
    ...
    render() {
      let i = this.walletImages.length < k;
      return e`${this.walletImages.slice(0, k).map(
        ({ src: a, walletName: o }) => e`
          <wui-wallet-image
            size="sm"
            imageSrc=${a}
            name=${f(o)}
    ...
    ${
      i
        ? [...Array(k - this.walletImages.length)].map(
            () => e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`
          )
        : null
    } `;
    }
...
S.styles = [b, R];
O([w({ type: Array })], S.prototype, "walletImages", void 0);
S = O([v("wui-all-wallets-image")], S);
var I = d`
  :host {
    width: 100%;
  }
...
c.styles = [b, P, I];
m([w({ type: Array })], c.prototype, "walletImages", void 0);
m([w()], c.prototype, "imageSrc", void 0);
m([w()], c.prototype, "name", void 0);
m([w()], c.prototype, "size", void 0);
m([w()], c.prototype, "tagLabel", void 0);
m([w()], c.prototype, "tagVariant", void 0);
m([w()], c.prototype, "walletIcon", void 0);
m([w()], c.prototype, "tabIdx", void 0);
m([w({ type: Boolean })], c.prototype, "disabled", void 0);
m([w({ type: Boolean })], c.prototype, "showAllWallets", void 0);
m([w({ type: Boolean })], c.prototype, "loading", void 0);
m([w({ type: String })], c.prototype, "loadingSpinnerColor", void 0);
c = m([v("wui-list-wallet")], c);
