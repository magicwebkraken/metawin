...
import { a as t, b as r, f as it, i as Fu, n as k } from "./chunk-VNDKUXGB.js";
var At = e({
  id: 16600,
...
var Re = {
  block: B({
    format(a) {
      let n = a.transactions?.map((s) => {
        if (typeof s == "string") return s;
        let l = Re.transaction?.format(s);
        return (
          l.typeHex === "0x71"
            ? (l.type = "eip712")
            : l.typeHex === "0xff" && (l.type = "priority"),
          l
        );
      });
      return {
        l1BatchNumber: a.l1BatchNumber ? d(a.l1BatchNumber) : null,
        l1BatchTimestamp: a.l1BatchTimestamp ? d(a.l1BatchTimestamp) : null,
        transactions: n,
      };
    },
  }),
  transaction: S({
    format(a) {
      ...
      return (
        a.type === "0x71"
          ? (n.type = "eip712")
          : a.type === "0xff" && (n.type = "priority"),
        r(t({}, n), {
          l1BatchNumber: a.l1BatchNumber ? d(a.l1BatchNumber) : null,
          l1BatchTxIndex: a.l1BatchTxIndex ? d(a.l1BatchTxIndex) : null,
        })
      );
    },
  }),
  transactionReceipt: $({
    format(a) {
      return {
        ...
        logs: a.logs.map((n) =>
          r(t({}, Tt(n)), {
            l1BatchNumber: n.l1BatchNumber ? d(n.l1BatchNumber) : null,
            transactionLogIndex: pt(n.transactionLogIndex),
            logType: n.logType,
          })
        ),
        l2ToL1Logs: a.l2ToL1Logs.map((n) => ({
          blockNumber: d(n.blockHash),
          blockHash: n.blockHash,
          l1BatchNumber: n.l1BatchNumber ? d(n.l1BatchNumber) : null,
          transactionIndex: d(n.transactionIndex),
          shardId: d(n.shardId),
          ...
          logIndex: d(n.logIndex),
        })),
      };
    },
  }),
  transactionRequest: J({
    exclude: [
      "customSignature",
      "factoryDeps",
      "gasPerPubdata",
    ...
    format(a) {
      return a.gasPerPubdata ||
        (a.paymaster && a.paymasterInput) ||
        a.factoryDeps ||
        a.customSignature
        ? {
            eip712Meta: t(
              t(
                t(
                  t(
                    {},
                    a.gasPerPubdata
                      ? { gasPerPubdata: c(a.gasPerPubdata) }
                      : { gasPerPubdata: c(F) }
                  ),
                  a.paymaster && a.paymasterInput
                    ? {
                        paymasterParams: {
                          ...
                          paymasterInput: Array.from(Z(a.paymasterInput)),
                        },
                      }
                    : {}
                ),
                a.factoryDeps
                  ? { factoryDeps: a.factoryDeps.map((n) => Array.from(Z(n))) }
                  : {}
              ),
              a.customSignature
                ? { customSignature: Array.from(Z(a.customSignature)) }
                : {}
            ),
            type: "0x71",
          }
...
function te(a) {
  return !!(
    a.type === "eip712" ||
    ("customSignature" in a && a.customSignature) ||
    ("paymaster" in a && a.paymaster) ||
    ("paymasterInput" in a && a.paymasterInput) ||
    ("gasPerPubdata" in a && typeof a.gasPerPubdata == "bigint") ||
    ("factoryDeps" in a && a.factoryDeps)
  );
}
function re(a) {
  let { chainId: n, to: s, from: l, paymaster: i, paymasterInput: m } = a;
  if (!te(a)) throw new ee();
  if (!n || n <= 0) throw new W({ chainId: n });
  if (s && !C(s)) throw new y({ address: s });
  if (l && !C(l)) throw new y({ address: l });
  if (i && !C(i)) throw new y({ address: i });
  if (i && !m)
    throw new b(
...
function Du(a, n) {
  return te(a) ? Mu(a) : Y(a, n);
}
var Dt = { transaction: Du };
function Mu(a) {
  let {
    chainId: n,
    gas: s,
...
var ae = class extends b {
    constructor({ givenLength: n, maxBytecodeSize: s }) {
      super(`Bytecode cannot be longer than ${s} bytes. Given length: ${n}`, {
        name: "BytecodeLengthExceedsMaxSizeError",
      });
    }
  },
  oe = class extends b {
    constructor({ givenLengthInWords: n }) {
      super(
        `Bytecode length in 32-byte words must be odd. Given length in words: ${n}`,
        { name: "BytecodeLengthInWordsMustBeOddError" }
      );
    }
  },
  ne = class extends b {
    constructor({ givenLength: n }) {
      super(
        `The bytecode length in bytes must be divisible by 32. Given length: ${n}`,
...
function Mt(a) {
  let n = X(a);
  if (n.length % 32 !== 0) throw new ne({ givenLength: n.length });
  if (n.length > Le)
    throw new ae({ givenLength: n.length, maxBytecodeSize: Le });
  let s = Et(n),
    l = X(s),
    i = n.length / 32;
  if (i % 2 === 0) throw new oe({ givenLengthInWords: i });
  let m = X(i),
    u = ct(m, { size: 2 }),
    f = new Uint8Array([1, 0]);
  return l.set(f, 0), l.set(u, 2), l;
}
var zt = (a) => {
  re(a);
  let n = zu(a);
  return {
    domain: { name: "zkSync", version: "2", chainId: a.chainId },
    types: {
      Transaction: [
...
function zu(a) {
  ...
  return {
    ...
    to: l ? BigInt(l) : 0n,
    gasLimit: n ?? 0n,
    gasPerPubdataByteLimit: T ?? F,
    maxFeePerGas: u ?? 0n,
    maxPriorityFeePerGas: f ?? 0n,
    paymaster: x ? BigInt(x) : 0n,
    nonce: s ? BigInt(s) : 0n,
    value: m ?? 0n,
    data: v ?? "0x",
    factoryDeps: h?.map((U) => c(Mt(U))) ?? [],
    paymasterInput: E || "0x",
  };
}
var p = {
...
var Ot = e({
  ...
  blockExplorers: {
    default: { name: "Acria Explorer", url: "https://explorer.acria.ai" },
  },
  testnet: !1,
});
var Pt = e({
...
var Nt = e({
  id: 9990,
  name: "Agung Network",
  nativeCurrency: { decimals: 18, name: "Agung", symbol: "AGNG" },
  rpcUrls: {
    default: {
  ...
  blockExplorers: {
    default: { name: "Subscan", url: "https://agung-testnet.subscan.io" },
  },
  testnet: !0,
});
var Lt = e({
...
var D = {
  block: B({
    format(a) {
      return {
        transactions: a.transactions?.map((s) => {
          if (typeof s == "string") return s;
          let l = Q(s);
          return (
            l.typeHex === "0x7e" &&
              ((l.isSystemTx = s.isSystemTx),
              (l.mint = s.mint ? d(s.mint) : void 0),
              (l.sourceHash = s.sourceHash),
              (l.type = "deposit")),
            l
          );
        }),
  ...
  transaction: S({
    format(a) {
      ...
      return (
        a.type === "0x7e" &&
          ((n.isSystemTx = a.isSystemTx),
          (n.mint = a.mint ? d(a.mint) : void 0),
          (n.sourceHash = a.sourceHash),
          (n.type = "deposit")),
        n
      );
    },
  ...
  transactionReceipt: $({
    format(a) {
      return {
        l1GasPrice: a.l1GasPrice ? d(a.l1GasPrice) : null,
        l1GasUsed: a.l1GasUsed ? d(a.l1GasUsed) : null,
        l1Fee: a.l1Fee ? d(a.l1Fee) : null,
...
function Ge(a, n) {
  return Iu(a) ? Hu(a) : Y(a, n);
}
var Kt = { transaction: Ge };
function Hu(a) {
  _u(a);
  let {
      sourceHash: n,
...
function _u(a) {
  let { from: n, to: s } = a;
  if (n && !C(n)) throw new y({ address: n });
  if (s && !C(s)) throw new y({ address: s });
}
var o = { blockTime: 2e3, contracts: se, formatters: D, serializers: Kt };
var le = 1,
  qt = e(
    r(t({}, o), {
      id: 888888888,
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [le]: { address: "0xB09DC08428C8b4EFB4ff9C0827386CDF34277996" },
        },
        portal: {
          [le]: {
...
var ie = 11155111,
  Xt = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [ie]: { address: "0x942fD5017c0F60575930D8574Eaca13BEcD6e1bB" },
        },
        portal: {
          [ie]: {
...
var or = e({
  ...
  blockExplorers: {
    default: { name: "Areum Explorer", url: "https://explorer.areum.network" },
  },
  contracts: {
    multicall3: {
      address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var ir = e({
  ...
  nativeCurrency: { decimals: 18, name: "Real World Asset", symbol: "RWA" },
...
var xr = e({
  id: 785,
  name: "Autheo Testnet",
  nativeCurrency: { decimals: 18, name: "Autheo", symbol: "THEO" },
  rpcUrls: {
    default: {
      http: [
...
var Nu = 168587773,
  Er = e({
    ...
    blockExplorers: {
      default: { name: "Blockscout", url: "https://sepolia.explorer.b3.fun" },
    },
    contracts: {
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var _ = 1,
  Ve = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [_]: { address: "0x43edB88C4B80fDD2AdFF2412A7BebF9dF42cB40e" },
        },
        l2OutputOracle: {
...
var ce = 5,
  Ur = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [ce]: { address: "0x2A35891ff30313CcFa6CE88dcf3858bb075A2298" },
        },
        multicall3: {
          address: "0xca11bde05977b3631167028862be2a173976ca11",
        ...
        portal: {
          [ce]: { address: "0xe93c8cD0D409341205A592f8c4Ac1A5fe5585cfA" },
        },
        l1StandardBridge: {
          [ce]: { address: "0xfA6D8Ee5BE770F84FC001D098C4bD604Fe01284a" },
        },
      }),
      testnet: !0,
      sourceId: ce,
...
var O = 11155111,
  je = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [O]: { address: "0xd6E6dBf4F7EA0ac412fD8b65ED297e64BB7a06E1" },
        },
        l2OutputOracle: {
          [O]: { address: "0x84457ca9D0163FbC4bbfe4Dfbb20ba46e48DF254" },
        },
        portal: {
          [O]: {
...
var Rr = e({
  ...
  blockExplorers: {
    default: { name: "bitlayer mainnet scan", url: "https://www.btrscan.com" },
  },
  contracts: {
    multicall3: {
...
var Vr = e({
  ...
  blockExplorers: {
    default: { name: "Bitrock Explorer", url: "https://explorer.bit-rock.io" },
  },
  testnet: !1,
});
var jr = e({
...
var Yr = e({
  ...
  blockExplorers: {
    default: { name: "BoolScan", url: "https://beta-mainnet.boolscan.com/" },
  },
  testnet: !1,
});
var $r = e({
  ...
  blockExplorers: {
    default: { name: "Botanixscan", url: "https://botanixscan.io" },
  },
});
var ea = e({
  id: 3636,
...
var ta = e({
  ...
  blockExplorers: { default: { name: "BB Scan", url: "https://bbscan.io" } },
  testnet: !1,
});
var ra = e({
  id: 6e3,
...
var ia = e({
  ...
  blockExplorers: {
    default: { name: "blockscout", url: "https://explorer.bsquared.network" },
  },
});
var ca = e({
  id: 1123,
...
var pa = e({
  ...
  blockExplorers: {
    default: { name: "Bitlayer(BTR) Scan", url: "https://www.btrscan.com" },
  },
});
var ma = e({
  id: 200810,
  ...
  blockExplorers: {
    default: { name: "Bitlayer(BTR) Scan", url: "https://testnet.btrscan.com" },
  },
  testnet: !0,
});
var da = e({
...
var ba = {
  estimateFeesPerGas: (a) =>
    k(void 0, null, function* () {
      if (!a.request?.feeCurrency) return null;
      let [n, s] = yield Promise.all([
        Ru(a.client, a.request.feeCurrency),
        Gu(a.client, a.request.feeCurrency),
      ]);
      return { maxFeePerGas: a.multiply(n - s) + s, maxPriorityFeePerGas: s };
    }),
};
function Ru(a, n) {
  return k(this, null, function* () {
    let s = yield a.request({ method: "eth_gasPrice", params: [n] });
    return BigInt(s);
  });
}
function Gu(a, n) {
  return k(this, null, function* () {
    let s = yield a.request({
...
function Xe(a) {
  return (
    ...
    a === "" ||
    (typeof a == "string" &&
      (Ne(a).toLowerCase() === "0x" || Ne(a).toLowerCase() === "0x00"))
  );
}
function M(a) {
  return !Xe(a);
...
function Vu(a) {
  return typeof a.maxFeePerGas < "u" && typeof a.maxPriorityFeePerGas < "u";
}
function me(a) {
  return a.type === "cip64" ? !0 : Vu(a) && M(a.feeCurrency);
}
var xa = {
  block: B({
    format(a) {
        ...
        transactions: a.transactions?.map((s) => {
          ...
          return r(
            t(
              ...
              s.gatewayFee
                ? {
                    gatewayFee: d(s.gatewayFee),
                    gatewayFeeRecipient: s.gatewayFeeRecipient,
                  }
                : {}
            ),
  ...
  transaction: S({
    format(a) {
      if (a.type === "0x7e")
        return {
          isSystemTx: a.isSystemTx,
          mint: a.mint ? d(a.mint) : void 0,
          sourceHash: a.sourceHash,
          type: "deposit",
        };
      let n = { feeCurrency: a.feeCurrency };
      return (
        a.type === "0x7b"
          ? (n.type = "cip64")
          : (a.type === "0x7c" && (n.type = "cip42"),
            (n.gatewayFee = a.gatewayFee ? d(a.gatewayFee) : null),
            (n.gatewayFeeRecipient = a.gatewayFeeRecipient)),
        n
      );
    },
  }),
  transactionRequest: J({
    format(a) {
      let n = {};
      return (
        a.feeCurrency && (n.feeCurrency = a.feeCurrency),
        me(a) && (n.type = "0x7b"),
        n
      );
    },
...
function ju(a, n) {
  return me(a) ? Ku(a, n) : Ge(a, n);
}
var Ca = { transaction: ju };
function Ku(a, n) {
  Xu(a);
  let {
      chainId: s,
...
function Xu(a) {
  ...
  if (n <= 0) throw new W({ chainId: n });
  if (m && !C(m)) throw new y({ address: m });
  if (l) throw new b("`gasPrice` is not a valid CIP-64 Transaction attribute.");
  if (M(i) && i > qu) throw new ut({ maxFeePerGas: i });
  if (M(s) && M(i) && s > i)
    throw new ht({ maxFeePerGas: i, maxPriorityFeePerGas: s });
  if (M(u) && !C(u))
    throw new b(
      "`feeCurrency` MUST be a token address for CIP-64 transactions."
    );
  if (Xe(u))
    throw new b("`feeCurrency` must be provided for CIP-64 transactions.");
}
var w = {
  blockTime: 1e3,
  contracts: se,
...
var Ta = e({
  ...
  blockExplorers: {
    default: { name: "Chang Chain explorer", url: "https://cthscan.com" },
  },
});
var va = e({
  id: 88888,
...
var ga = e({
  ...
  rpcUrls: {
    default: { http: ["https://coinbit-rpc-mainnet.chain.sbcrypto.app"] },
  },
  blockExplorers: {
    default: {
...
var Va = e({
  ...
  nativeCurrency: { decimals: 18, name: "Cronos zkEVM CRO", symbol: "zkCRO" },
...
var qa = e({
  ...
  nativeCurrency: { decimals: 18, name: "CrossFi", symbol: "XFI" },
...
var $a = e({
  ...
  blockExplorers: {
    default: { name: "DBK Chain Explorer", url: "https://scan.dbkchain.io" },
  },
  testnet: !1,
});
var eo = e(
...
var lo = e({
  ...
  blockExplorers: {
    default: { name: "DisChain Explorer", url: "https://www.oklink.com/dis" },
  },
});
var io = e({
  id: 53457,
...
var co = e({
  id: 2e3,
  name: "Dogechain",
  nativeCurrency: { decimals: 18, name: "Wrapped Dogecoin", symbol: "WDOGE" },
...
var mo = e({
  ...
  blockExplorers: {
    default: { name: "Donatuz Explorer", url: "https://explorer.donatuz.com" },
  },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var ho = e({
  ...
  nativeCurrency: { decimals: 18, name: "DOS Chain Testnet", symbol: "DOS" },
...
var Co = e({
  ...
  blockExplorers: { default: { name: "Dym FYI", url: "https://dym.fyi" } },
  testnet: !1,
});
var ko = e({
  id: 5424,
...
var Io = e({
  id: 173,
  name: "ENI Mainnet",
  nativeCurrency: { decimals: 18, name: "ENI", symbol: "ENI" },
  rpcUrls: { default: { http: ["https://rpc.eniac.network"] } },
  blockExplorers: {
    default: { name: "ENI Explorer", url: "https://scan.eniac.network" },
  },
  testnet: !1,
});
var _o = e({
  id: 6912115,
  name: "ENI Testnet",
  nativeCurrency: { decimals: 18, name: "ENI Testnet Token", symbol: "ENI" },
...
var Go = e({
  ...
  blockExplorers: {
    default: { name: "Etherlink", url: "https://explorer.etherlink.com" },
  },
  contracts: {
    multicall3: {
      address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var Ko = e({
  ...
  blockExplorers: { default: { name: "ETP Scan", url: "https://etpscan.xyz" } },
});
var qo = e({
  id: 9001,
  name: "Evmos",
...
var Wo = e({
  ...
  blockExplorers: {
    default: { name: "Expanse Explorer", url: "https://explorer.expanse.tech" },
  },
  testnet: !1,
});
var Jo = e({
...
var cn = e({
  ...
  blockExplorers: {
    default: { name: "Mainnet Explorer", url: "https://evm.flowscan.io" },
  },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var mn = e({
  ...
  blockExplorers: {
    default: { name: "Flow Diver", url: "https://evm-testnet.flowscan.io" },
  },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var z = 1,
  bn = e({
    ...
    blockExplorers: {
      default: { name: "Form Explorer", url: "https://explorer.form.network" },
    },
    contracts: r(t({}, o.contracts), {
      addressManager: {
        [z]: { address: "0x15c249E46A2F924C2dB3A1560CF86729bAD1f07B" },
      },
      l1CrossDomainMessenger: {
        [z]: { address: "0xF333158DCCad1dF6C3F0a3aEe8BC31fA94d9eD5c" },
      },
      l2OutputOracle: {
        [z]: { address: "0x4ccAAF69F41c5810cA875183648B577CaCf1F67E" },
      },
      portal: {
        [z]: { address: "0x4E259Ee5F4136408908160dD32295A5031Fa426F" },
      },
      l1StandardBridge: {
        [z]: { address: "0xdc20aA63D3DE59574E065957190D8f24e0F7B8Ba" },
      },
      multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
    }),
    sourceId: z,
...
var H = 11155111,
  Cn = e({
    ...
    contracts: r(t({}, o.contracts), {
      addressManager: {
        [H]: { address: "0xd5C38fa934f7fd7477D4800F4f38a1c5BFdF1373" },
      },
      l1CrossDomainMessenger: {
        [H]: { address: "0x37A68565c4BE9700b3E3Ec60cC4416cAC3052FAa" },
      },
      l2OutputOracle: {
        [H]: { address: "0x9eA2239E65a59EC9C7F1ED4C116dD58Da71Fc1e2" },
      },
      portal: {
        [H]: { address: "0x60377e3cE15dF4CCA24c4beF076b60314240b032" },
      },
      l1StandardBridge: {
        [H]: { address: "0xD4531f633942b2725896F47cD2aFd260b44Ab1F7" },
      },
      multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
    }),
    testnet: !0,
...
var kn = e({
  ...
  rpcUrls: {
    default: { http: ["https://rpc-forta-chain-8gj1qndmfc.t.conduit.xyz"] },
  },
  blockExplorers: {
    default: { name: "Forta Explorer", url: "https://explorer.forta.org" },
  },
});
var yn = e({
  id: 31337,
...
var ue = 1,
  En = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [ue]: { address: "0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4" },
        },
        multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
        portal: {
          [ue]: {
...
var he = 17e3,
  Tn = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [he]: { address: "0x715EA64DA13F4d0831ece4Ad3E8c1aa013167F32" },
        },
        multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
        portal: {
          [he]: {
...
var gn = e({
  ...
  blockExplorers: { default: { name: "FSNscan", url: "https://fsnscan.com" } },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
  ...
  Mn = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        disputeGameFactory: {
          [be]: { address: "0x37347caB2afaa49B776372279143D71ad1f354F6" },
        },
        portal: {
          [be]: { address: "0x956962C34687A954e611A83619ABaA37Ce6bC78A" },
        },
        l1StandardBridge: {
          [be]: { address: "0x77b2ffc0F57598cAe1DB76cb398059cF5d10A7E7" },
        },
      }),
      testnet: !0,
      sourceId: be,
...
var Xn = e({
  ...
  nativeCurrency: { name: "tGURU Token", symbol: "tGURU", decimals: 18 },
  rpcUrls: {
    default: {
      http: [
  ...
  blockExplorers: {
    default: { name: "Guruscan", url: "https://sepolia.gurunetwork.ai" },
  },
  testnet: !0,
});
var Zn = e({
...
var es = e({
  id: 177,
  name: "HashKey Chain",
  nativeCurrency: { decimals: 18, name: "HashKey EcoPoints", symbol: "HSK" },
...
var ms = e({
  ...
  blockExplorers: { default: { name: "hpbScan", url: "https://hscan.org" } },
  testnet: !1,
});
var Yu = 42161,
  ds = e({
...
var Es = e({
  id: 73115,
  name: "ICB Network",
  nativeCurrency: { decimals: 18, name: "ICB Native Token", symbol: "ICBX" },
...
var Ts = e({
  ...
  blockExplorers: {
    default: { name: "IDChain Explorer", url: "https://explorer.idchain.one" },
  },
  testnet: !1,
});
var vs = e({
  ...
  Fs = e(
    r(t({}, o), {
      ...
      contracts: r(
        ...
        {
          disputeGameFactory: {
            [xe]: { address: "0x10d7b35078d3baabb96dd45a9143b94be65b12cd" },
          },
          portal: {
            [xe]: { address: "0x5d66c1782664115999c47c9fa5cd031f495d3e4f" },
          },
          l1StandardBridge: {
            [xe]: { address: "0x88ff1e5b602916615391f55854588efcbb7663f0" },
          },
        }
      ),
      testnet: !1,
  ...
  Ds = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        disputeGameFactory: {
          [Ce]: { address: "0x860e626c700af381133d9f4af31412a2d1db3d5d" },
        },
        portal: {
          [Ce]: { address: "0x5c1d29c6c9c8b0800692acc95d700bcb4966a1d7" },
        },
        l1StandardBridge: {
          [Ce]: { address: "0x33f60714bbd74d62b66d79213c348614de51901c" },
        },
      }),
      testnet: !0,
      sourceId: Ce,
...
var Rs = e({
  ...
  name: "Jovay Mainnet",
  nativeCurrency: { decimals: 18, name: "Ether", symbol: "ETH" },
  rpcUrls: { default: { http: ["https://api.zan.top/public/jovay-mainnet"] } },
  blockExplorers: {
    default: { name: "Jovay Explorer", url: "https://explorer.jovay.io" },
  },
  testnet: !1,
});
var Gs = e({
...
var js = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo BCH1-Chain", symbol: "BCH1" },
  rpcUrls: {
...
var Ks = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo DAI1-Chain", symbol: "DAI1" },
  rpcUrls: {
...
var qs = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo DOGE1-Chain", symbol: "DOGE1" },
  rpcUrls: {
...
var Xs = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo EUR1-Chain", symbol: "EUR1" },
  rpcUrls: {
...
var Zs = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo GLD1-Chain", symbol: "GLD1" },
  rpcUrls: {
...
var Ws = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo LINK1-Chain", symbol: "LINK1" },
  rpcUrls: {
...
var Js = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo LTC1-Chain", symbol: "LTC1" },
  rpcUrls: {
...
var Qs = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo mBTC1-Chain", symbol: "mBTC1" },
  rpcUrls: {
...
var Ys = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo SGD1-Chain", symbol: "SGD1" },
  rpcUrls: {
...
var $s = e({
  ...
  nativeCurrency: { decimals: 18, name: "Socotra JUNE-Chain", symbol: "JUNE" },
  rpcUrls: {
...
var el = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo USD1-Chain", symbol: "USD1" },
  rpcUrls: {
...
var tl = e({
  ...
  nativeCurrency: { decimals: 18, name: "Juneo USDT1-Chain", symbol: "USDT1" },
  rpcUrls: {
...
var ul = e({
  ...
  blockExplorers: {
    default: { name: "Kinto Explorer", url: "https://explorer.kinto.xyz" },
  },
  testnet: !1,
});
var hl = e({
...
var El = e({
  ...
  rpcUrls: {
    default: { http: ["https://tsub360890-eth-rpc.thetatoken.org/rpc"] },
  },
  blockExplorers: {
    default: {
...
var wl = e({
  ...
  blockExplorers: {
    default: { name: "Lestnet Explorer", url: "https://explore.lestnet.org" },
  },
  testnet: !0,
});
var Ul = e({
  ...
  return k(this, null, function* () {
    ...
    try {
      let i = n,
        ...
        nt = (typeof u == "bigint" ? mt(u) : void 0) || f;
      yt(n);
      let st = a.chain?.formatters?.transactionRequest?.format,
        lt = (st || xt)(
          r(t({}, bt(Au, { format: st })), {
            from: l?.address,
            accessList: m,
        ...
        ),
        {
          baseFeePerGas: gu,
          gasLimit: Su,
          priorityFeePerGas: Bu,
        } = yield a.request({
          method: "linea_estimateGas",
          params: nt ? [lt, nt] : [lt],
        });
      return {
        baseFeePerGas: BigInt(gu),
        gasLimit: BigInt(Su),
        priorityFeePerGas: BigInt(Bu),
      };
    } catch (m) {
      throw ft(m, r(t({}, n), { account: l, chain: a.chain }));
    }
  });
}
var I = {
  fees: {
    estimateFeesPerGas: Sl,
    maxPriorityFeePerGas(l) {
      return k(
        this,
        arguments,
        function* ({ block: a, client: n, request: s }) {
          let i = yield Sl({
            block: a,
            client: n,
            multiply: (m) => m,
          ...
          return i?.maxPriorityFeePerGas ? i.maxPriorityFeePerGas : null;
        }
      );
    },
  },
...
function Sl(i) {
  return k(
    this,
    arguments,
    function* ({ client: a, multiply: n, request: s, type: l }) {
      try {
        let m = yield gl(a, r(t({}, s), { account: s?.account })),
          { priorityFeePerGas: u } = m,
          h = n(BigInt(m.baseFeePerGas)) + u;
        return l === "legacy"
          ? { gasPrice: h }
          : { maxFeePerGas: h, maxPriorityFeePerGas: u };
      } catch {
        return null;
      }
    }
  ...
  zl = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        l2OutputOracle: {
          [ke]: { address: "0x113cB99283AF242Da0A0C54347667edF531Aa7d6" },
        },
        portal: {
          [ke]: { address: "0x26dB93F8b8b4f7016240af62F7730979d353f9A7" },
        },
        l1StandardBridge: {
          [ke]: { address: "0x2658723Bf70c7667De6B25F99fcce13A16D25d08" },
        },
      }),
      sourceId: ke,
    })
...
var ye = 11155111,
  Hl = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [ye]: { address: "0xA0E35F56C318DE1bD5D9ca6A94Fe7e37C5663348" },
        },
        multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
        portal: {
          [ye]: { address: "0xe3d90F21490686Ec7eF37BE788E02dfC12787264" },
        },
        l1StandardBridge: {
          [ye]: { address: "0x1Fb30e446eA791cd1f011675E5F3f5311b70faF5" },
        },
      }),
      testnet: !0,
      sourceId: ye,
...
var Ll = e({
  ...
  blockExplorers: {
    default: { name: "Lumia Explorer", url: "https://explorer.lumia.org/" },
  },
  contracts: {
    multicall3: {
      address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var Vl = e({
  id: 105363,
  name: "Lumoz Testnet",
  nativeCurrency: { decimals: 18, name: "Lumoz Testnet Token", symbol: "MOZ" },
...
var jl = e({
  ...
  blockExplorers: {
    default: { name: "Lycan Explorer", url: "https://explorer.lycanchain.com" },
  },
});
var Kl = e({
  id: 957,
...
var ei = e({
  ...
  nativeCurrency: { decimals: 18, name: "OM", symbol: "OM" },
  rpcUrls: { default: { http: ["https://evm.dukong.mantrachain.io"] } },
  blockExplorers: {
    default: { name: "MANTRAScan", url: "https://mantrascan.io/dukong" },
  },
  testnet: !0,
});
var ti = e({
  ...
  blockExplorers: {
    default: { name: "MANTRA Scan", url: "https://mantrascan.io/mainnet" },
  },
});
var ri = e({
  id: 22776,
...
var oi = e({
  ...
  blockExplorers: {
    default: { name: "Matchain Scan", url: "https://testnet.matchscan.io" },
  },
  testnet: !0,
});
var ni = e({
...
var ii = e({
  ...
  blockExplorers: { default: { name: "MELDscan", url: "https://meldscan.io" } },
  contracts: {
    multicall3: {
...
var Ee = 1,
  bi = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [Ee]: { address: "0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426" },
        },
        multicall3: {
          address: "0xcA11bde05977b3631167028862bE2a173976CA11",
          blockCreated: 0,
        ...
        portal: {
          [Ee]: { address: "0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956" },
        },
        l1StandardBridge: {
          [Ee]: { address: "0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3" },
        },
      }),
      sourceId: Ee,
    })
...
var Ei = e({
  id: 59902,
  name: "Metis Sepolia",
  nativeCurrency: { decimals: 18, name: "Test Metis", symbol: "tMETIS" },
  rpcUrls: {
    default: {
      http: [
  ...
  gi = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        l2OutputOracle: {
          [Te]: { address: "0x4317ba146D4933D889518a3e5E11Fe7a53199b04" },
        },
        portal: {
          [Te]: { address: "0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07" },
        },
        l1StandardBridge: {
          [Te]: { address: "0x735aDBbE72226BD52e818E7181953f42E3b0FF21" },
        },
      }),
      sourceId: Te,
    })
...
var Zi = e({
  ...
  blockExplorers: { default: { name: "NibiScan", url: "https://nibiscan.io" } },
  contracts: {
    multicall3: {
      address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var tc = e({
  ...
  blockExplorers: {
    default: { name: "OmniScan", url: "https://omniscan.network" },
  },
  testnet: !1,
});
var rc = e({
  ...
  blockExplorers: {
    default: { name: "Omega OmniScan", url: "https://omega.omniscan.network/" },
  },
  testnet: !0,
});
var ac = e({
...
var we = 56,
  nc = e({
    ...
    contracts: r(t({}, o.contracts), {
      ...
      l2OutputOracle: {
        [we]: { address: "0x153CAB79f4767E2ff862C94aa49573294B13D169" },
      },
      portal: {
        [we]: { address: "0x1876EA7702C0ad0C6A2ae6036DE7733edfBca519" },
      },
      l1StandardBridge: {
        [we]: { address: "0xF05F0e4362859c3331Cb9395CBC201E3Fa6757Ea" },
      },
    }),
    sourceId: we,
  });
var Ue = 97,
  sc = e({
    ...
    contracts: r(t({}, o.contracts), {
      ...
      l2OutputOracle: {
        [Ue]: { address: "0xFf2394Bb843012562f4349C6632a0EcB92fC8810" },
      },
      portal: {
        [Ue]: { address: "0x4386C8ABf2009aC0c263462Da568DD9d46e52a31" },
      },
      l1StandardBridge: {
        [Ue]: { address: "0x677311Fd2cCc511Bbc0f581E8d9a07B033D5E840" },
      },
    }),
    testnet: !0,
    sourceId: Ue,
...
var P = 1,
  ic = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [P]: { address: "0xe5965Ab5962eDc7477C8520243A95517CD252fA9" },
        },
        l2OutputOracle: {
          [P]: { address: "0xdfe97868233d1aa22e815a266982f2cf17685a27" },
        },
        multicall3: {
          address: "0xca11bde05977b3631167028862be2a173976ca11",
        ...
        portal: {
          [P]: { address: "0xbEb5Fc579115071764c7423A4f12eDde41f106Ed" },
        },
        l1StandardBridge: {
          [P]: { address: "0x99C9fc46f92E8a1c0deC1b1747d010903E884bE1" },
        },
      }),
      sourceId: P,
    })
...
var Ae = 5,
  cc = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [Ae]: { address: "0xE6Dfba0953616Bacab0c9A8ecb3a9BBa77FC15c0" },
        },
        multicall3: {
          address: "0xca11bde05977b3631167028862be2a173976ca11",
          blockCreated: 49461,
        ...
        portal: {
          [Ae]: { address: "0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383" },
        },
        l1StandardBridge: {
          [Ae]: { address: "0x636Af16bf2f682dD3109e60102b8E1A089FedAa8" },
        },
      }),
      testnet: !0,
      sourceId: Ae,
...
var N = 11155111,
  pc = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [N]: { address: "0x05F9613aDB30026FFd634f38e5C4dFd30a197Fa1" },
        },
        l2OutputOracle: {
          [N]: { address: "0x90E9c4f8a994a250F6aEfd61CAFb4F2e895D458F" },
        },
        multicall3: {
          address: "0xca11bde05977b3631167028862be2a173976ca11",
          blockCreated: 1620204,
        ...
        portal: {
          [N]: { address: "0x16Fc5058F25648194471939df75CF27A2fdC48BC" },
        },
        l1StandardBridge: {
          [N]: { address: "0xFBb0621E0B23b5478B630BD55a5f21f67730B0F1" },
        },
      }),
      testnet: !0,
      sourceId: N,
...
var mc = e({
  ...
  blockExplorers: {
    default: { name: "Optopia Explorer", url: "https://scan.optopia.ai" },
  },
  testnet: !1,
});
var dc = e({
...
var ge = 1,
  kc = e({
    ...
    contracts: {
      l2OutputOracle: {
        [ge]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" },
      },
      multicall3: {
        address: "0xcA11bde05977b3631167028862bE2a173976CA11",
      ...
      portal: {
        [ge]: { address: "0xb26Fd985c5959bBB382BAFdD0b879E149e48116c" },
      },
      l1StandardBridge: {
        [ge]: { address: "0xD0204B9527C1bA7bD765Fa5CCD9355d38338272b" },
      },
    },
    formatters: D,
    sourceId: ge,
...
var Se = 11155111,
  yc = e({
    ...
    contracts: {
      l2OutputOracle: {
        [Se]: { address: "0xD5bAc3152ffC25318F848B3DD5dA6C85171BaEEe" },
      },
      portal: {
        [Se]: { address: "0xF04BdD5353Bb0EFF6CA60CfcC78594278eBfE179" },
      },
      l1StandardBridge: {
        [Se]: { address: "0xFaE6abCAF30D23e233AC7faF747F2fC3a5a6Bfa3" },
      },
      multicall3: {
        address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var Tc = e({
  ...
  blockExplorers: {
    default: { name: "Planq Explorer", url: "https://evm.planq.network" },
  },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var Uc = e({
  ...
  blockExplorers: {
    default: { name: "RouteScan", url: "https://testnet.plasmascan.to" },
  },
  contracts: {
    multicall3: {
      address: "0xcA11bde05977b3631167028862bE2a173976CA11",
...
var Lc = e({
  ...
  blockExplorers: {
    default: { name: "Polynomial Scan", url: "https://polynomialscan.io" },
  },
  testnet: !1,
  contracts: {
    multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
...
var qc = 11155111,
  Xc = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l1StandardBridge: {
          [qc]: { address: "0xC24932c31D9621aE9e792576152B7ef010cFC2F8" },
        },
      }),
    })
  );
var Zc = e({
  ...
  contracts: {
    multicall3: { address: "0x7A52370716ea730585884F5BDB0f6E60C39b8C64" },
  },
  testnet: !1,
});
var Wc = e({
...
var up = e({
  ...
  network: "rootstock",
  nativeCurrency: { decimals: 18, name: "Rootstock Bitcoin", symbol: "tRBTC" },
...
var Fe = 1,
  hp = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [Fe]: { address: "0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10" },
        },
        multicall3: {
          address: "0xca11bde05977b3631167028862be2a173976ca11",
          blockCreated: 14193,
        ...
        l1StandardBridge: {
          [Fe]: { address: "0x4cbab69108Aa72151EDa5A3c164eA86845f18438" },
        },
      }),
      sourceId: Fe,
    })
...
var De = 11155111,
  fp = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [De]: { address: "0xDb5c46C3Eaa6Ed6aE8b2379785DF7dd029C0dC81" },
        },
        multicall3: {
          address: "0xca11bde05977b3631167028862be2a173976ca11",
          blockCreated: 55697,
        ...
        l1StandardBridge: {
          [De]: { address: "0xdDD29bb63B0839FB1cE0eE439Ff027738595D07B" },
        },
      }),
      testnet: !0,
      sourceId: De,
...
var xp = e({
  ...
  blockExplorers: {
    default: { name: "Saga Explorer", url: "https://sagaevm.sagaexplorer.io" },
  },
  contracts: {
    multicall3: {
...
var kp = e({
  ...
  blockExplorers: {
    default: { name: "Sanko Explorer", url: "https://explorer.sanko.xyz" },
  },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var Lp = e({
  id: 97453,
  name: "Sidra Chain",
  nativeCurrency: { decimals: 18, name: "Sidra Digital Asset", symbol: "SDA" },
...
var Vp = e({
  ...
  blockExplorers: {
    default: { name: "Six Protocol Scan", url: "https://sixscan.io/sixnet" },
  },
  testnet: !1,
});
var jp = e({
...
var L = 1,
  nm = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [L]: { address: "0x472562Fcf26D6b2793f8E0b0fB660ba0E5e08A46" },
        },
        l2OutputOracle: {
          [L]: { address: "0x2172e492Fc807F5d5645D0E3543f139ECF539294" },
        },
        multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
        portal: {
          [L]: { address: "0x79f446D024d74D0Bb6E699C131c703463c5D65E9" },
        },
        l1StandardBridge: {
          [L]: { address: "0x6534Bdb6b5c060d3e6aa833433333135eFE8E0aA" },
        },
      }),
      sourceId: L,
    })
...
var R = 11155111,
  sm = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [R]: { address: "0x206a75d89d45F146C54020F132FF93bEDD09f55E" },
        },
        l2OutputOracle: {
          [R]: { address: "0x60e3A368a4cdCEf85ffB964e372726F56A46221e" },
        },
        multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
        portal: {
          [R]: { address: "0xb5afdd0E8dDF081Ef90e8A3e0c7b5798e66E954E" },
        },
        l1StandardBridge: {
          [R]: { address: "0xbd37E1a59D4C00C9A46F75018dffd84061bC5f74" },
        },
      }),
      testnet: !0,
      sourceId: R,
...
var G = 1,
  im = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [G]: { address: "0x512a3d2c7a43bd9261d2b8e8c9c70d4bd4d503c0" },
        },
        l2OutputOracle: {
          [G]: { address: "0x0000000000000000000000000000000000000000" },
        },
        portal: {
          [G]: {
...
var V = 11155111,
  cm = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        disputeGameFactory: {
          [V]: { address: "0xB3Ad2c38E6e0640d7ce6aA952AB3A60E81bf7a01" },
        },
        l2OutputOracle: {
          [V]: { address: "0x710e5286C746eC38beeB7538d0146f60D27be343" },
        },
        portal: {
          [V]: {
...
var mm = e({
  ...
  nativeCurrency: { decimals: 18, name: "Coston Flare", symbol: "CFLR" },
  rpcUrls: {
...
var xm = e({
  ...
  blockExplorers: {
    default: { name: "Sova Block Explorer", url: "hhttps://explorer.sova.io" },
  },
  testnet: !1,
});
var Cm = e({
...
var Am = e({
  ...
  blockExplorers: {
    default: { name: "Lumio explorer", url: "https://explorer.lumio.io" },
  },
  testnet: !1,
});
var gm = e({
...
var _m = e({
  ...
  blockExplorers: {
    default: { name: "SwissDLT Explorer", url: "https://explorer.swissdlt.ch" },
  },
  testnet: !1,
});
var Om = e({
...
var Rm = e({
  ...
  contracts: {
    multicall3: { address: "0xcb2436774C3e191c85056d248EF4260ce5f27A9D" },
  },
});
var Gm = e({
  id: 167009,
...
var Zm = e({
  ...
  blockExplorers: {
    default: { name: "Tea Sepolia Explorer", url: "https://sepolia.tea.xyz" },
  },
  testnet: !0,
});
var Wm = e({
...
var sd = e({
  ...
  blockExplorers: {
    default: { name: "TikTrix Testnet Explorer", url: "https://tiktrix.xyz" },
  },
  testnet: !0,
});
var ld = e({
...
var xd = e({
  ...
  blockExplorers: {
    default: { name: "Ultron Scan", url: "https://explorer.ultron-dev.io" },
  },
  testnet: !0,
});
var ze = 1,
  Cd = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        disputeGameFactory: {
          [ze]: { address: "0x2F12d621a16e2d3285929C9996f478508951dFe4" },
        },
        portal: {
          [ze]: { address: "0x0bd48f6B86a26D3a217d0Fa6FfE2B491B956A7a2" },
        },
        l1StandardBridge: {
          [ze]: { address: "0x81014F44b0a345033bB2b3B21C7a1A308B35fEeA" },
        },
      }),
      sourceId: ze,
    })
  ...
  kd = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        portal: {
          [He]: { address: "0x0d83dab629f0e0F9d36c0Cbc89B69a489f0751bD" },
        },
        l1StandardBridge: {
          [He]: { address: "0xea58fcA6849d79EAd1f26608855c2D6407d54Ce2" },
        },
        disputeGameFactory: {
          [He]: { address: "0xeff73e5aa3B9AEC32c659Aa3E00444d20a84394b" },
        },
      }),
      testnet: !0,
      sourceId: He,
...
var yd = e({
  ...
  blockExplorers: {
    default: { name: "Unique Subscan", url: "https://unique.subscan.io/" },
  },
});
var Ed = e({
  id: 8882,
...
var Td = e({
  ...
  blockExplorers: {
    default: { name: "Quartz Subscan", url: "https://quartz.subscan.io/" },
  },
});
var vd = e({
  id: 18233,
...
var wd = e({
  ...
  name: "Vana",
  blockTime: 6e3,
  nativeCurrency: { decimals: 18, name: "Vana", symbol: "VANA" },
...
var Bd = e({
  ...
  blockExplorers: { default: { name: "VIC Scan", url: "https://vicscan.xyz" } },
  testnet: !1,
});
var Fd = e({
  id: 89,
...
var zd = e({
  ...
  blockExplorers: { default: { name: "WanScan", url: "https://wanscan.org" } },
  contracts: {
    multicall3: {
  ...
  Gd = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        disputeGameFactory: {
          [K]: { address: "0x069c4c579671f8c120b1327a73217D01Ea2EC5ea" },
        },
        l2OutputOracle: {
          [K]: { address: "0x19A6d1E9034596196295CF148509796978343c5D" },
        },
        portal: {
          [K]: { address: "0xd5ec14a83B7d95BE1E2Ac12523e2dEE12Cbeea6C" },
        },
        l1StandardBridge: {
          [K]: { address: "0x470458C91978D2d929704489Ad730DC3E3001113" },
        },
      }),
      testnet: !1,
      sourceId: K,
  ...
  Vd = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        disputeGameFactory: {
          [q]: { address: "0x8Ec1111f67Dad6b6A93B3F42DfBC92D81c98449A" },
        },
        l2OutputOracle: {
          [q]: { address: "0xc8886f8BAb6Eaeb215aDB5f1c686BF699248300e" },
        },
        portal: {
          [q]: { address: "0xFf6EBa109271fe6d4237EeeD4bAb1dD9A77dD1A4" },
        },
        l1StandardBridge: {
          [q]: { address: "0xd7DF54b3989855eb66497301a4aAEc33Dbb3F8DE" },
        },
      }),
      testnet: !0,
      sourceId: q,
...
var Kd = e({
  ...
  blockExplorers: {
    default: { name: "Blockscout", url: "https://explorer.xai-chain.net" },
  },
  contracts: {
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
var Jd = e({
  id: 20250217,
  name: "Xphere Mainnet",
  nativeCurrency: { decimals: 18, name: "XP", symbol: "XP" },
  rpcUrls: { default: { http: ["https://en-bkk.x-phere.com"] } },
  blockExplorers: {
    default: { name: "Xphere Tamsa Explorer", url: "https://xp.tamsa.io" },
  },
  testnet: !1,
});
var Qd = e({
  id: 1998991,
  name: "Xphere Testnet",
  nativeCurrency: { decimals: 18, name: "XPT", symbol: "XPT" },
  rpcUrls: { default: { http: ["http://testnet.x-phere.com"] } },
  blockExplorers: {
    default: { name: "Xphere Tamsa Explorer", url: "https://xpt.tamsa.io" },
  },
  testnet: !0,
});
var Yd = e({
...
var ou = e({
  ...
  blockExplorers: { default: { name: "Zentrace", url: "https://zentrace.io" } },
  testnet: !0,
});
var nu = e({
  id: 383414847825,
...
var lu = e({
  ...
  blockExplorers: {
    default: { name: "ZetaScan", url: "https://zetascan.com" },
  },
  testnet: !1,
});
var iu = e({
  ...
  blockExplorers: {
    default: { name: "ZetaScan", url: "https://testnet.zetascan.com" },
  },
  testnet: !0,
});
var cu = e({
  ...
  du = e(
    r(t({}, o), {
      ...
      contracts: {
        multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
        l2OutputOracle: {
          [Ye]: { address: "0x92Ef6Af472b39F1b363da45E35530c24619245A4" },
        },
        portal: {
          [Ye]: { address: "0x17bfAfA932d2e23Bd9B909Fd5B4D2e2a27043fb1" },
        },
        l1StandardBridge: {
          [Ye]: { address: "0x386B76D9cA5F5Fb150B6BFB35CF5379B22B26dd8" },
        },
      },
      testnet: !1,
    })
  ...
  uu = e(
    r(t({}, o), {
      ...
      contracts: {
        multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
        l2OutputOracle: {
          [$e]: { address: "0xd69D3AC5CA686cCF94b258291772bc520FEAf211" },
        },
        portal: {
          [$e]: { address: "0x4E21A71Ac3F7607Da5c06153A17B1DD20E702c21" },
        },
        l1StandardBridge: {
          [$e]: { address: "0x87a7E2bCA9E35BA49282E832a28A6023904460D8" },
        },
      },
      testnet: !0,
    })
  ...
  hu = e(
    r(t({}, o), {
      ...
      contracts: {
        ...
        l2OutputOracle: {
          [et]: { address: "0x740C2dac453aEf7140809F80b72bf0e647af8148" },
        },
        portal: {
          [et]: { address: "0x787f1C8c5924178689E0560a43D848bF8E54b23e" },
        },
        l1StandardBridge: {
          [et]: { address: "0x0545c5fe980098C16fcD0eCB5E79753afa6d9af9" },
        },
      },
      testnet: !0,
    })
...
var bu = e({
  ...
  blockExplorers: {
    default: { name: "zkFair Explorer", url: "https://testnet-scan.zkfair.io" },
  },
  testnet: !0,
});
var xu = e({
...
var Ie = 1,
  Tu = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [Ie]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" },
        },
        multicall3: {
          address: "0xcA11bde05977b3631167028862bE2a173976CA11",
          blockCreated: 5882,
        ...
        portal: {
          [Ie]: { address: "0x1a0ad011913A150f69f6A19DF447A0CfD9551054" },
        },
        l1StandardBridge: {
          [Ie]: { address: "0x3e2Ea9B92B7E48A52296fD261dc26fd995284631" },
        },
      }),
      sourceId: Ie,
    })
...
var _e = 11155111,
  vu = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        l2OutputOracle: {
          [_e]: { address: "0x2615B481Bd3E5A1C0C7Ca3Da1bdc663E8615Ade9" },
        },
        multicall3: {
          address: "0xcA11bde05977b3631167028862bE2a173976CA11",
          blockCreated: 83160,
        ...
        portal: {
          [_e]: { address: "0xeffE2C6cA9Ab797D418f0D91eA60807713f3536f" },
        },
        l1StandardBridge: {
          [_e]: { address: "0x5376f1D543dcbB5BD416c56C189e4cB7399fCcCB" },
        },
      }),
      sourceId: _e,
      testnet: !0,
  ...
  Uu = e(
    r(t({}, o), {
      ...
      contracts: r(t({}, o.contracts), {
        ...
        portal: {
          [wu]: { address: "0xDb9F51790365e7dc196e7D072728df39Be958ACe" },
        },
      }),
      sourceId: wu,
      testnet: !0,
...
Fu(sh, {
  ...
  arenaz: () => tr,
  areonNetwork: () => rr,
  areonNetworkTestnet: () => ar,
  areum: () => or,
  artelaTestnet: () => nr,
  arthera: () => sr,
  artheraTestnet: () => lr,
  assetChain: () => ir,
  assetChainTestnet: () => cr,
  astar: () => pr,
  astarZkEVM: () => mr,
  astarZkyoto: () => dr,
  atletaOlympia: () => ur,
  ...
  basePreconf: () => vr,
  baseSepolia: () => je,
  baseSepoliaPreconf: () => Ar,
  basecampTestnet: () => wr,
  beam: () => gr,
  beamTestnet: () => Sr,
  bearNetworkChainMainnet: () => Br,
  bearNetworkChainTestnet: () => Fr,
  berachain: () => Dr,
  berachainBepolia: () => Mr,
  berachainTestnet: () => zr,
  berachainTestnetbArtio: () => Hr,
  bevmMainnet: () => Ir,
  bifrost: () => _r,
  birdlayer: () => Or,
  bitTorrent: () => jr,
  bitTorrentTestnet: () => Kr,
  bitgert: () => Pr,
  bitkub: () => Nr,
  bitkubTestnet: () => Lr,
  bitlayer: () => Rr,
  ...
  crab: () => _a,
  creatorTestnet: () => Oa,
  creditCoin3Devnet: () => Pa,
  creditCoin3Mainnet: () => Na,
  creditCoin3Testnet: () => La,
  cronos: () => Ra,
  cronosTestnet: () => Ga,
  cronoszkEVM: () => Va,
  cronoszkEVMTestnet: () => ja,
  crossbell: () => Ka,
  crossfi: () => qa,
  curtis: () => Xa,
  cyber: () => Za,
  cyberTestnet: () => Wa,
  dailyNetwork: () => Ja,
  dailyNetworkTestnet: () => Qa,
  darwinia: () => Ya,
  dbkchain: () => $a,
  dchain: () => eo,
  dchainTestnet: () => to,
  defichainEvm: () => ro,
  defichainEvmTestnet: () => ao,
  degen: () => oo,
  dfk: () => no,
  diode: () => so,
  disChain: () => lo,
  ...
  exsatTestnet: () => Qo,
  fantom: () => Yo,
  fantomSonicTestnet: () => $o,
  fantomTestnet: () => en,
  fibo: () => tn,
  filecoin: () => rn,
  filecoinCalibration: () => an,
  filecoinHyperspace: () => on,
  fireChain: () => Bt,
  flame: () => nn,
  flare: () => sn,
  flareTestnet: () => ln,
  ...
  hychain: () => Cs,
  hychainTestnet: () => ks,
  hyperliquidEvmTestnet: () => ys,
  iSunCoin: () => _s,
  icbNetwork: () => Es,
  idchain: () => Ts,
  immutableZkEvm: () => vs,
  immutableZkEvmTestnet: () => ws,
  inEVM: () => Us,
  initVerse: () => As,
  initVerseGenesis: () => gs,
  injective: () => Ss,
  ...
  mandala: () => Xl,
  manta: () => Zl,
  mantaSepoliaTestnet: () => Wl,
  mantaTestnet: () => Jl,
  mantle: () => Ql,
  mantleSepoliaTestnet: () => Yl,
  mantleTestnet: () => $l,
  mantraDuKongEVMTestnet: () => ei,
  mantraEVM: () => ti,
  mapProtocol: () => ri,
  matchain: () => ai,
  matchainTestnet: () => oi,
  ...
  memecore: () => ci,
  merlin: () => mi,
  merlinErigonTestnet: () => di,
  metachain: () => ui,
  metachainIstanbul: () => hi,
  metadium: () => fi,
  metalL2: () => bi,
  meter: () => xi,
  meterTestnet: () => Ci,
  ...
  polygonMumbai: () => _c,
  polygonZkEvm: () => Oc,
  polygonZkEvmCardona: () => Pc,
  polygonZkEvmTestnet: () => Nc,
  polynomial: () => Lc,
  polynomialSepolia: () => Rc,
  premiumBlockTestnet: () => Gc,
  pulsechain: () => Vc,
  pulsechainV4: () => jc,
  pumpfiTestnet: () => Kc,
  pyrope: () => Xc,
  ...
  siliconSepolia: () => Gp,
  sixProtocol: () => Vp,
  skaleBlockBrawlers: () => jp,
  skaleCalypso: () => Kp,
  skaleCalypsoTestnet: () => qp,
  skaleCryptoBlades: () => Xp,
  skaleCryptoColosseum: () => Zp,
  skaleEuropa: () => Wp,
  skaleEuropaTestnet: () => Jp,
  skaleExorde: () => Qp,
  skaleHumanProtocol: () => Yp,
  skaleNebula: () => $p,
  skaleNebulaTestnet: () => em,
  skaleRazor: () => tm,
  skaleTitan: () => rm,
  skaleTitanTestnet: () => am,
  sketchpad: () => om,
  snax: () => nm,
  snaxTestnet: () => sm,
  somniaTestnet: () => lm,
  ...
  surgeTestnet: () => Fm,
  swan: () => Dm,
  swanProximaTestnet: () => Mm,
  swanSaturnTestnet: () => zm,
  swellchain: () => Hm,
  swellchainTestnet: () => Im,
  swissdlt: () => _m,
  syscoin: () => Om,
  syscoinTestnet: () => Pm,
  tac: () => Nm,
  ...
  westendAssetHub: () => Pd,
  whitechain: () => Nd,
  whitechainTestnet: () => Ld,
  wmcTestnet: () => Rd,
  worldLand: () => jd,
  worldchain: () => Gd,
  worldchainSepolia: () => Vd,
  x1Testnet: () => Qe,
  xLayer: () => Wd,
  xLayerTestnet: () => Qe,
  xai: () => Kd,
  ...
  xrplevmTestnet: () => eu,
  yooldoVerse: () => ru,
  yooldoVerseTestnet: () => au,
  zenchainTestnet: () => ou,
  zeniq: () => nu,
  zeroG: () => At,
  zeroGGalileoTestnet: () => gt,
  zeroGMainnet: () => St,
  zeroNetwork: () => su,
  zetachain: () => lu,
  zetachainAthensTestnet: () => iu,
  zhejiang: () => cu,
  zilliqa: () => pu,
  zilliqaTestnet: () => mu,
  zircuit: () => du,
  zircuitGarfieldTestnet: () => uu,
  zircuitTestnet: () => hu,
  zkFair: () => fu,
  zkFairTestnet: () => bu,
  zkLinkNova: () => xu,
  zkLinkNovaSepoliaTestnet: () => Cu,
  zkSync: () => tt,
  zkSyncInMemoryNode: () => rt,
  zkSyncLocalNode: () => at,
  zkSyncSepoliaTestnet: () => ot,
  zksync: () => tt,
  zksyncInMemoryNode: () => rt,
  zksyncLocalCustomHyperchain: () => ku,
  zksyncLocalHyperchain: () => yu,
  zksyncLocalHyperchainL1: () => Eu,
  zksyncLocalNode: () => at,
  zksyncSepoliaTestnet: () => ot,
  zora: () => Tu,
  zoraSepolia: () => vu,
